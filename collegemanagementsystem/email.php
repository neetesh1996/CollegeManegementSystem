...
<div class="error">'.$error.'</div>
   ...
   $result = mysqli_query($conn, "SELECT fullname FROM `users` WHERE email='".$email."'") or die(mysqli_error());
...
$output.='<p><br></p>';
$output.='<p><a href="http://localhost/coding/collegemanagementsystem/reset-password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">
http://localhost/coding/collegemanagementsystem/reset-password.php
