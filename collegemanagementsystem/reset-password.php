...
deactivated.</p>
<p><a href="http://localhost/coding/collegemanagementsystem/email.php">
</a> Try again!.</p> 
 <a href="email.php"><input type="submit" id="signup_btn" value="Reset Password"/>
 <a href="login?reg=true.php"><input type="button" name="loginSubmit"  id="back_btn" value="Back"/></a><br/>
</div>
</body>
</html>';
...
if ($pass1=$pass2){
  ...
  $query="select * from users where password = '".md5($pass1)."'";
...
<p><a href="http://localhost/coding/collegemanagementsystem/login.php?reg=true">
</a> Now you can Login.</p></div><br /> <a href="login.php?reg=true"><input type="button" name="loginSubmit"  id="back_btn" value="Login"/></a><br/>
</div>
</body>
</html>';
   }
